...
const videoFile = path.join(__dirname, 'videos', scenarioName, scenario.config.video.outputFileName);
const audioDir = path.join(__dirname, 'videos', scenarioName, scenario.config.audio.outputDir);
const outputFile = path.join(__dirname, 'videos', scenarioName, scenario.config.video.finalOutputFileName);
